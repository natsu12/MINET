...
public class GroupChatUI extends JFrame {
	 ...
	 * Create the frame.
	 */    
	public GroupChatUI(User user) {
	   
	    
		setResizable(false);
		setTitle("Minet-groupchat");
       ...
       // tree.setMaximumSize(new Dimension(400, 600));
		...
		addmemButton = new JButton("添加用户");
		addmemButton.setBounds(430, 100, 90, 23);
            ...
            public void actionPerformed(ActionEvent e)
            {
            	...
            	addmemberui.getButtonReg().addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						membername = addmemberui.getTextFieldName().getText();
    ...
    public JButton getAddMemButton() 
    {
    	return addmemButton;
    }
}
